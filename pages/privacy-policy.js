...
export default function PrivacyPolicy({ seo }) {
  ...
  const { url, organizationLegal } = seo.defaultSeo

  return (
    <div className="w-full">
      <Head>
        <title>Privacy Policy - {metaTitle}</title>
        <link rel="canonical" href={hostname}/>
        <meta name="title" content={`Privacy Policy - ${metaTitle}`} />
        <meta name="description" content={`${metaDescription}`}/>
        <meta property="og:title" content={`Privacy Policy - ${metaTitle}`} key="title" />
